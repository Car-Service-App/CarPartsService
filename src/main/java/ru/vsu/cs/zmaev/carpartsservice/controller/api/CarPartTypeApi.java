...
@Tag(name = "CarPartType Api", description = "Api для работы с типами запчастей")
public interface CarPartTypeApi {
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    ...
                    content = {
                            @Content(
                                    ...
                                    schema = @Schema(implementation = CarPartTypeResponseDto.class)
                            )
                    }
            ),
            @ApiResponse(
    ...
    ResponseEntity<CarPartTypeResponseDto> findOneById(@Parameter(description = "id автомобиля") Long id);
    ...
    ResponseEntity<Page<CarPartTypeResponseDto>> findAllWithFilters(
            ...
            Integer pageSize,
            @Parameter(description = "Тип детали")
            @RequestParam(required = false) String partType,
            @Parameter(description = "Категория детали")
    ...
    ResponseEntity<CarPartTypeResponseDto> create(@Valid CarPartTypeRequestDto dto);
